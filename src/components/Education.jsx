            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                <div className="relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
                    {education.map((item, index) => {
                        ...
                        return (
                            <div key={index} className={`relative flex items-center justify-between md:justify-center mb-12 group ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                                {/* Marker */}
                                <div className="absolute left-5 md:left-1/2 -translate-x-1/2 flex items-center justify-center w-10 h-10 rounded-full border-4 border-[#0a0a0a] bg-primary/20 text-primary shadow z-10 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                                ...
                                <motion.div
                                    ...
                                    className={`w-full ml-16 md:ml-0 md:w-1/2 ${isLeft ? 'md:pr-12' : 'md:pl-12'}`}
                                >
                                ...
                                {/* Empty space for desktop to force centering */}
